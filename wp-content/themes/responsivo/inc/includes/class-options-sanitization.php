...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'responsivo' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'responsivo' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'responsivo' ),
		'repeat'    => esc_html__( 'Repeat All', 'responsivo' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'responsivo' ),
		'top center'    => esc_html__( 'Top Center', 'responsivo' ),
		'top right'     => esc_html__( 'Top Right', 'responsivo' ),
		'center left'   => esc_html__( 'Middle Left', 'responsivo' ),
		'center center' => esc_html__( 'Middle Center', 'responsivo' ),
		'center right'  => esc_html__( 'Middle Right', 'responsivo' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'responsivo' ),
		'bottom center' => esc_html__( 'Bottom Center', 'responsivo' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'responsivo')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'responsivo' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'responsivo')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'responsivo' ),
		'italic'      => esc_html__( 'Italic', 'responsivo' ),
		'bold'        => esc_html__( 'Bold', 'responsivo' ),
		'bold italic' => esc_html__( 'Bold Italic', 'responsivo' )
		);
